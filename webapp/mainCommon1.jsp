...
<%@page import="com.resource.locale.*"%>
...
<%-- <%@ taglib prefix="qre" uri="qretaglib"%> --%>
<html>
<head>
...
<LINK REL="StyleSheet" HREF="<%=ctx%>theme/tabpane.css" TYPE="text/css"> 
<LINK REL="StyleSheet" HREF="<%=ctx%>theme/style.css" TYPE="text/css">  
<LINK REL="StyleSheet" HREF="<%=ctx%>theme/superTables.css" TYPE="text/css">  
...
<%  
    ...
    ResourceBundleHandler resourceBundleHandler = new ResourceBundleHandler(screenModel.getScreenName(),lang.substring(0,lang.length()-1));
%>
...
<body class="main" style='overflow-x:scroll; overflow-y:scroll; width=690px;' onload="initSub('Demo');doLoad();" onKeyDown="return checkAllKeys();" <%="onResize='doResize();'"%> onHelp="return screenHelp();" onClick='doClick(this);' onBeforeUnload='return doCheck()' unUnload='doCancel()'>
