...
@Entity
@Table(name="UPSMUIFL")
@Vsam(name="UPSMUIFL", type=FileType.KeySequenced, length=100, fixedLength=true)
@VsamKsds(keyLength = 10)
public class UpsmuiflKsdsVsam extends IndexedVsamFile {

	public UpsmuiflKsdsVsam(String name) {
		super(name);
	}
